...
'한국은행 금통위 위원 김종화는 6월 25일, "가계부채 및 주택시장 불안 요인이 커지고 있다"며 금융안정에 대한 강한 우려를 표명했다. 지난 5월에는 기준금리를 2.50%로 인하했으며, 이번 분기에도 완화 가능성을 열어두었으나, 주택가격 급등과 가계대출 증가세를 고려할 때 매우 신중한 접근이 필요하다고 강조했다. 5월 가계대출 증가치는 2024년 9월 이후 최고 수준을 기록했으며, 여기에 스테이블코인 관련 금융 리스크까지 복합적으로 고려 중이다. 김 위원은 "정부와의 정책 공조를 통해 위험을 최소화해야 한다"고 밝혔다.',
'Reuters (via News)', '2025-06-25 14:07:00'),
...
'Reuters (via News)', '2025-06-19 09:35:00'),
...
'Reuters (via News)', '2025-06-18 07:41:00'),
...
'Business Times SG', '2025-06-25 10:00:00'),
('韓 가계대출 증가율 1.7배…정책 부담 커졌다',
'2025년 1분기 기준 한국 가계가처분소득 대비 총대출 비율(DTI)이 186.5%를 기록했다. 주택담보대출 증가세는 9조7000억원으로 나타났으며, 이는 한은의 3단계 DSR 규제 강화 방침과 맞물려 부동산 시장의 불안 요소로 작용하고 있다. 류상대 한은 부총재는 “가계부채와 주택시장 집중도가 현재 정책 방향 설정의 핵심 변수”라고 언급하며 금리 정책 운용에 신중을 기했다.',
'AInvest', '2025-06-25 08:00:00'),
('韓 “암호화폐 스폿 ETF, 2025년 도입 목표”',
'6월 24일, 외신에 따르면 금융위원회는 스폿형 암호화폐 ETF 도입을 위해 규제 및 투자자보호체계를 정비 중이라 밝혔다. 해당 로드맵에는 스테이블코인 허용 기준 마련, 거래소 수수료 조사 강화, 시장 모니터링 체계 구축 등이 포함되며, 금융위는 “디지털자산 시장 진입 장벽을 낮추되 리스크는 확실히 관리할 것”이라고 강조했다.',
'Coindesk (via CCN)', '2025-06-24 12:00:00'),
('한은 금통위, 완화 지속하되 주택시장 신중 관찰',
'6월 17일 공개된 한은 금통위 회의록에서 위원들은 통화정책 완화 기조를 유지하기로 합의했으나, 주요 리스크로 주택시장 불안과 가계대출 과잉을 지목했다. 한 위원은 “금리 인하 속도를 조절해 주택시장 거품을 경계해야 한다”고 강조했으며, 다른 위원은 “재정·금융 조치를 병행해야 취약계층을 보호할 수 있다”고 말했다.',
'Reuters (via News)', '2025-06-17 07:41:51'),
('美 무역관세 우려 속 韓 경제성장률 전망 0.8%',
'5월 29일, 한국은행은 올해 경제성장률을 기존 1.5%에서 0.8%로 대폭 하향 조정했다. 이는 미국의 고율 관세 정책, 대내외 정치 불확실성, 소비·투자 부진 등이 원인으로 지목됐다. 한은은 금리 인하를 단행하며 경기 회복을 도모하는 동시에 금융안정 리스크를 면밀히 감시하겠다고 밝혔다.',
'Reuters (via News)', '2025-05-29 03:11:00');
